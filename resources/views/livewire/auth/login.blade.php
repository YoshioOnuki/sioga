{{-- <div class="row align-items-center g-4">
        ...
        <div class="container-tight">
            <div class="text-center mb-4">
                <a href="." class="navbar-brand navbar-brand-autodark">
                    <img src="{{ asset('media/logo-light.PNG') }}" height="100" alt="Logo" class="rounded">
                </a>
            </div>
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <form autocomplete="off" novalidate wire:submit.prevent="ingresar">
                        <div class="mb-3">
    ...
    <div class="col-lg d-none d-lg-block">
        <img src="{{ asset('assets/media/undraw_updated_resume_re_7r9j.svg') }}" height="300"
            class="d-block mx-auto mb-4" alt="">
        <h1 class="text-gray-800 text-center" style="font-weight: 700;">
            Bienvenido a SIOGA
        </h1>
        <div class="text-gray-600 fs-4 text-center fw-semibold">
...
<div class="row g-0 flex-fill">
        ...
        <div class="container container-tight my-5 px-lg-5">
            <div class="text-center mb-4">
                <a class="navbar-brand navbar-brand-autodark">
                    <img src="{{ asset('media/logo-dark.PNG') }}" height="100" alt="Logo" class="rounded hide-theme-light">
                    <img src="{{ asset('media/logo-light.PNG') }}" height="100" alt="Logo" class="rounded hide-theme-dark">
                </a>
            </div>
            <h1 class="text-gray-800 text-center" style="font-weight: 700;">
                Bienvenido a SIOGA
    ...
    <div class="col-12 col-lg-6 col-xl-8 d-none d-lg-block">
        <div class="bg-cover h-100 min-vh-100" style="background-image: url({{ asset('assets/media/foto-2-1.webp') }})">
        </div>
    </div>
</div>
